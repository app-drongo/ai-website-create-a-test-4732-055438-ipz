...
export default function Footer() {
  ...
  const handleContactClick = (method: string) => {
    console.log(`Initiating contact via ${method}`);
  };
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="flex items-center gap-3 text-sm hover:text-primary transition-colors w-full text-left"
              >
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get technical updates, API changes, and platform announcements. Unsubscribe anytime.
              </p>
            </div>
          </div>
